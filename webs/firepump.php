  ...
  <div class="main">
    ...
    <div class="content content-summary" id="pageSummary">
      ...
      <div class="summary-main-row">
        <section class="card">
          <div class="card-header">
            <div>
              <div class="card-title">2.2 อัตราสถานีปกติ (จาก API)</div>
        ...
        <section class="card">
          <div class="card-header">
            <div>
              <div class="card-title">2.3 สถานีจากฐานข้อมูล (Top 10)</div>
    ...
    <div class="content" id="pageTemp">
      <section class="card">
        <div class="card-header">
          <div>
            <div class="card-title">3.1 อุณหภูมิแบบ Realtime (MQTT)</div>
    ...
    <div class="content" id="pageRaw">
      <section class="card">
        <div class="card-header">
          <div>
            <div class="card-title">3.2 ข้อมูลดิบจาก MQTT (Raw JSON)</div>
            <div class="card-subtitle">
