...
<main class="main-content">
    <header class="topbar">
      <div style="display:flex; align-items:center; gap:12px;">
        ...
        <div><div style="font-weight:700; color: #fff; font-size: 1rem;">Motor Drive Control Room Monitoring</div><div style="font-size: 0.65rem; color: #64748b;">Designed & Created by IT Team</div></div>
      </div>
