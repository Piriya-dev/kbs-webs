...
<aside class="sidebar">
    <div class="sidebar-nav">
        <a href="/motor_drive_room_dashboard" class="nav-item <?php echo (basename($_SERVER['PHP_SELF']) == 'motor_drive_status.php' ? 'active' : ''); ?>">
            <span class="icon">📊</span><span class="text">Dashboard</span>
        </a>

        <?php if ($_SESSION['role'] === 'admin'): ?>
        <a href="/motor_drive_room_settings" class="nav-item <?php echo (basename($_SERVER['PHP_SELF']) == 'setting.php' ? 'active' : ''); ?>">
            <span class="icon">⚙️</span><span class="text">Settings</span>
        </a>
        <?php endif; ?>
        
        <a href="/motor_drive_room_report" class="nav-item <?php echo (basename($_SERVER['PHP_SELF']) == 'station_report.php' ? 'active' : ''); ?>">
            <span class="icon">📈</span><span class="text">Report</span>
        </a>

        <a href="/motor_drive_room_debug" class="nav-item">
            <span class="icon">🔍</span><span class="text">JSON Debug Page</span>
        </a>
    </div>

    <div style="padding: 20px; border-top: 1px solid #334155; margin-top: auto;">
        <a href="/motor_drive_room_logout" style="text-decoration:none; color: #ef4444; font-size: 0.8rem; font-weight: bold;">
            🔓 LOGOUT
        </a>
    </div>
</aside>
