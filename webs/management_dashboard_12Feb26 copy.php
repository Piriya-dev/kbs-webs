    ...
    <div class="flex justify-between text-rose-400">
        ...
        <div class="lg:col-span-5 grid grid-rows-2 gap-4">
            <div class="grid grid-cols-3 gap-4">
                <div class="flat-card border-t-4 border-emerald-500 p-5 flex flex-col justify-center items-center bg-emerald-500/5">
                    <span class="text-[12px] text-emerald-400 font-bold uppercase tracking-wider">พร้อมใช้งาน</span>
                    <div class="text-4xl font-black text-white mt-1 italic"><?= number_format($totals['ready_y']) ?></div>
                </div>
                <div class="flat-card border-t-4 border-rose-500 p-5 flex flex-col justify-center items-center bg-rose-500/5">
                    <span class="text-[12px] text-rose-400 font-bold uppercase tracking-wider">ไม่พร้อมใช้งาน</span>
                    <div class="text-4xl font-black text-white mt-1 italic"><?= number_format($totals['ready_n']) ?></div>
                </div>
                <div class="flat-card border-t-4 border-indigo-500 p-5 flex flex-col justify-center items-center bg-indigo-500/5">
                    <span class="text-[12px] text-indigo-400 font-bold uppercase tracking-wider">รอมอบหมาย</span>
                    <div class="text-4xl font-black text-white mt-1 italic"><?= number_format($totals['assigned']) ?></div>
                </div>
            </div>
            <div class="grid grid-cols-3 gap-4">
                <div class="flat-card border-t-4 border-sky-500 p-5 flex flex-col justify-center items-center bg-sky-500/5">
                    <span class="text-[12px] text-sky-400 font-bold uppercase tracking-wider">ถูกใช้งาน</span>
                    <div class="text-4xl font-black text-white mt-1 italic"><?= number_format($totals['used']) ?></div>
                </div>
                <div class="flat-card border-t-4 border-amber-500 p-5 flex flex-col justify-center items-center bg-amber-500/5">
                    <span class="text-[12px] text-amber-400 font-bold uppercase tracking-wider">รอใช้งาน</span>
                    <div class="text-4xl font-black text-white mt-1 italic"><?= number_format($totals['stb']) ?></div>
                </div>
                <div class="flat-card border-t-4 border-rose-900 p-5 flex flex-col justify-center items-center bg-rose-900/10">
                    <span class="text-[12px] text-rose-500 font-bold uppercase tracking-wider">เสีย</span>
                    <div class="text-4xl font-black text-white mt-1 italic"><?= number_format($totals['brk']) ?></div>
                </div>
            </div>
        </div>
    </div>
